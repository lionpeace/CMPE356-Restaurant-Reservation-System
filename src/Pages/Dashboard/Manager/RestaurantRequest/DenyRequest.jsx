...
function DenyRequest() {
    ...
    return (
        <>
            ...
            <div id="content">
                <h1 className="page-name">Deny Request</h1>
                <div className="approve-request-div mb-4">
                    <form className="approve-request-form">
                        ...
                        <div class="mb-3">
                            <label for="reasonOfDeny" class="form-label">Reason of Deny</label>
                            <textarea class="form-control" id="reasonOfDeny" rows="3"></textarea>
                        </div>
                        ...
                        <div className="form-check text-center pt-3">
                            ...
                            <label className="form-check-label" htmlFor="ownerApprove">
                                I checked my reason for rejection more than once. I informed the requester.
                            </label>
                        </div>

                        <div className="btn-div-deny-request">
                            <button type="submit" className="btn-deny-request">Deny Request</button>
                        </div>
                    </form>
                </div>
            </div>
